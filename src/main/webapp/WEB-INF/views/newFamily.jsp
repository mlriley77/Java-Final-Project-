<%@ page import="com.grandcircus.spring.controller.HomeController" %><%--
...
<div class="container">
    <div class="row gutter" id="page-title-row">
        <div class="col-12">
            <h1 id="page-title" class="display-4">Register A New Parent Account</h1>
        </div>
    </div>
    <div class="row gutter" id="content-holder">
        <form id="newFamily" action= "${pageContext.request.contextPath}/action=register/family/submit" method="post" style="margin:0;padding:0;width:100%;">
            ...
            <div class="form-group row justify-content-center">
                ...
                <div class="col-6">
                    <input class="form-control" title="Family Name"
                           type="text" id="famName" name="famName"/>
                </div>
            </div>
            ...
            <div class="form-group row justify-content-center">
                <label for="famName" class="col-2 col-form-label">Last Name</label>
                <div class="col-6">
            ...
            <div class="form-group row justify-content-center">
                <label for="famName" class="col-2 col-form-label">Email</label>
                <div class="col-6">
            ...
            <div class="form-group row justify-content-center">
                <label for="famName" class="col-2 col-form-label">Password</label>
                <div class="col-6">
            ...
            <div class="form-group row justify-content-center">
                <label for="famName" class="col-2 col-form-label">Confirm Password</label>
                <div class="col-6">
